...
//        }
        ...
        // if ("https://gmeet.tech".equals(baseCallUrl)) {
        val jibriManager = JibriManager()
        val baseCallUrl = "https://${mucClient?.id}:${jibriManager.gmeetPort}/gmeet"
        // }
        // baseCallUrl = "$baseCallUrl/gmeet"
        logger.info("baseCallUrl = $baseCallUrl, subdomain = $subdomain, domain = $domain, callName = $callName, baseUrl = $baseUrl")
        return when {
